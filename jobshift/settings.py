...
# 不該拿對方的站台當測試靶。
BASE_URL = (
    os.getenv("JOBSHIFT_BASE_URL") or "https://www.1111.com.tw/api/v1/search/jobs/"
)
FETCH_PARAMS_BASE = {
    "sortBy": "da",
    "sortOrder": "desc",
...
SLEEP_PAGE_MIN = float(os.getenv("CRAWL_SLEEP_PAGE_MIN", "7"))
SLEEP_PAGE_MAX = float(os.getenv("CRAWL_SLEEP_PAGE_MAX", "10"))
SLEEP_RUN_MIN = float(os.getenv("CRAWL_SLEEP_RUN_MIN", "20"))  # 每輪之間
SLEEP_RUN_MAX = float(os.getenv("CRAWL_SLEEP_RUN_MAX", "25"))
